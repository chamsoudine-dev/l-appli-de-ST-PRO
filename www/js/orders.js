...
function onContractPeriodChange() {
  ...
  const quickSchedule = document.getElementById('quick-schedule-wrap');
  ...
  if (!startVal || !endVal || endVal < startVal) {
    ...
    if (quickSchedule) quickSchedule.style.display = 'none';
    return;
  }
  ...
  if (quickSchedule) quickSchedule.style.display = 'block';
...
/**
 * Construit le calendrier semaine par semaine entre startVal et endVal.
 */
